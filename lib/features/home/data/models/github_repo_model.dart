  ...
  GithubRepoModel.fromJson(dynamic json) {
    ...
    if (json['items'] != null) {
      ...
      json['items'].forEach((v) {
        items?.add(RepoItemModel.fromJson(v));
      });
    }
  }
...
class RepoItemModel {
  ...
  RepoItemModel.fromJson(dynamic json) {
    id = json['id'];
    nodeId = json['node_id'];
    name = json['name'];
    ...
    owner =
        json['owner'] != null ? RepoOwnerModel.fromJson(json['owner']) : null;
...
class RepoOwnerModel {
  ...
  RepoOwnerModel.fromJson(dynamic json) {
    login = json['login'];
    id = json['id'];
    nodeId = json['node_id'];
